...
class PolicyTableHeader extends React.Component {
...
class PolicyTable extends React.Component {
	...
	handleDelete = (item) => {
		this.props.onDeletePolicy(item);
	};
									...
									return (
										<TableRow hover role="checkbox" tabIndex={-1} key={n.id}>
											...
											<TableCell>
												<FormControlLabel
													control={
														<Switch checked={n.portal_access} value={n.portal_access} />
													}
												/>
											</TableCell>
											...
											<TableCell>
												<FormControlLabel
													control={
														<Switch checked={n.app_access} value={n.app_access} />
													}
												/>
											</TableCell>
