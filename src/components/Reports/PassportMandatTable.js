...
const columnData = [
	{ id: 'country', numeric: false, disablePadding: true, label: 'Offer Content' },
...
class PassportTableHeader extends React.Component {
...
class PassportMandatTable extends React.Component {
	constructor(props) {
		super(props);
...
PassportMandatTable.propTypes = {
	classes: PropTypes.object.isRequired
};

export default withStyles(styles)(PassportMandatTable);
