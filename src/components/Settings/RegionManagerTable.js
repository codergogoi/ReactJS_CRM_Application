...
const columnData = [
	{ id: 'name', numeric: false, disablePadding: false, label: 'Region Manager' },
	{ id: 'email', numeric: false, disablePadding: false, label: 'Login ID' },
	{ id: 'region', numeric: false, disablePadding: false, label: 'Region' },
	{ id: 'region_id', numeric: false, disablePadding: false, label: 'Region ID' },
	{ id: 'action', numeric: false, disablePadding: false, label: 'Action' }
];

class RegionManagerTableHeader extends React.Component {
...
RegionManagerTableHeader.propTypes = {
...
class RegionManagerTable extends React.Component {
	constructor(props) {
		super(props);
								...
								.map((n) => {
									return (
										<TableRow hover role="checkbox" tabIndex={-1} key={n.id}>
											...
											<TableCell>{n.region_id}</TableCell>
											<TableCell>
												<IconButton
...
RegionManagerTable.propTypes = {
	classes: PropTypes.object.isRequired
};

export default withStyles(styles)(RegionManagerTable);
