...
const columnData = [
	{ id: 'msg', numeric: false, disablePadding: true, label: 'Offer Content' },
	{ id: 'sector_from', numeric: false, disablePadding: true, label: 'Sector From To' },
	{ id: 'date_from', numeric: false, disablePadding: true, label: 'Validity' },
	{ id: 'aui', numeric: false, disablePadding: true, label: 'AUI | Country' },
	{ id: 'airlines', numeric: false, disablePadding: true, label: 'Airlines' },
	{ id: 'more', numeric: false, disablePadding: true, label: 'Action' }
];

class OffersTableHeader extends React.Component {
								...
								.map((n) => {
									return (
										<TableRow hover role="checkbox" tabIndex={-1} key={n.id}>
											...
											<TableCell>{n.from_sector + ' - ' + n.to_sector}</TableCell>
											<TableCell>
												{moment(n.date_from).format('Do MMM YYYY') +
													' - ' +
													moment(n.date_to).format('Do MMM YYYY')}
											</TableCell>
											<TableCell>{n.aui + ' ' + n.country}</TableCell>
