...
const columnData = [
	...
	{ id: 'validity', numeric: false, disablePadding: true, label: 'Promo Code | Validity | Section ' },
	{ id: 'tnc', numeric: false, disablePadding: true, label: 'T&C' },
	{ id: 'more', numeric: false, disablePadding: true, label: 'Action' }
];

class NotificationTableHeader extends React.Component {
...
class NotificationTable extends React.Component {
	...
	handleCloneClick = (notification) => {
		this.props.onCloneClick(notification);
	};

	handleDelete = (notification) => {
		console.log('Deleted' + JSON.stringify(notification));
		this.props.onDeleteNotification(notification);
	};
									...
									return (
										<TableRow hover role="checkbox" tabIndex={-1} key={n.id}>
											...
											<TableCell>
												{n.promo +
													' | ' +
													moment(n.validity).format('Do MMM YYYY') +
													' | ' +
													n.section}
											</TableCell>
											<TableCell>{n.tnc}</TableCell>
											<TableCell>
												<IconButton
												...
												<IconButton
													...
													mini
													aria-label="Edit"
													onClick={(event) => this.handleCloneClick(n)}
												>
													<CopyIcon />
												</IconButton>
											</TableCell>
