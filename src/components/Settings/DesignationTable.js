...
DesignationTableHeader.propTypes = {
...
class DesignationTable extends React.Component {
	constructor(props) {
		super(props);
	...
	handleDelete = (item) => {
		this.props.onDeleteDesignation(item);
	};
...
export default withStyles(styles)(DesignationTable);
